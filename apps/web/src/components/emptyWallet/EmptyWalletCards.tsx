...
// SPRY: the buy and CEX-transfer (fiat on-ramp) cards were removed; only "receive crypto" remains.
export const EmptyWalletCards = (
  ...
  return (
    <Flex position="relative" width="100%" animation="fast" animateEnterExit="fadeInDownOutDown">
      ...
      >
        <Flex
          $platform-web={horizontalLayout ? { display: 'grid', gridTemplateColumns: '1fr' } : undefined}
          gap="$spacing12"
