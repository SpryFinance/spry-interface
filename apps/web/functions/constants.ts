// SPRY: the OG share-image watermark, served from our own origin. The image
// handlers prefix this with the request origin so it resolves on whatever
// domain Spry is deployed to, instead of a hardcoded app.uniswap.org URL.
export const WATERMARK_PATH = '/images/324x74_App_Watermark.png'
